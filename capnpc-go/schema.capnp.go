...
func ReadRootNodeNestedNode(s *C.Segment) NodeNestedNode { return NodeNestedNode(s.Root().ToStruct()) }
...
func ReadRootEnumerant(s *C.Segment) Enumerant       { return Enumerant(s.Root().ToStruct()) }
...
func ReadRootMethod(s *C.Segment) Method          { return Method(s.Root().ToStruct()) }
...
func ReadRootMethodParam(s *C.Segment) MethodParam     { return MethodParam(s.Root().ToStruct()) }
...
func ReadRootAnnotation(s *C.Segment) Annotation { return Annotation(s.Root().ToStruct()) }
...
func ReadRootCodeGeneratorRequest(s *C.Segment) CodeGeneratorRequest {
	return CodeGeneratorRequest(s.Root().ToStruct())
}
...
func ReadRootCodeGeneratorRequestRequestedFile(s *C.Segment) CodeGeneratorRequestRequestedFile {
	return CodeGeneratorRequestRequestedFile(s.Root().ToStruct())
}
...
func ReadRootCodeGeneratorRequestRequestedFileImport(s *C.Segment) CodeGeneratorRequestRequestedFileImport {
	return CodeGeneratorRequestRequestedFileImport(s.Root().ToStruct())
}
